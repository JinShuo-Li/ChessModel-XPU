...
|---|---|---|
| Formal checkpoint | [jinshuoli/chessmodel](https://huggingface.co/jinshuoli/chessmodel) | `checkpoints/formal_1m_latest.pt` — the `main_cuda` preset, 8,932,076 parameters |
